...
async def websocket_tts_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            await tts_streamer.generate_and_stream(text, websocket, emo_vector, emo_alpha, diffusion_steps)
...
async def get_test_page():
    ...
    <body>
        ...
        <input type="number" id="emoAlpha" placeholder="Emotion alpha (e.g., 0.8)" step="0.01" min="0" max="1.0" value="0.8" style="width: 400px;"><br><br>
